...
# ------------------------------------------------------------
# 3) Language switch button visual effect
# ------------------------------------------------------------
...
#    approved visual pattern, one-line guidance, red accent only
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# 6) Remove old lower/per-card language toggle
# ------------------------------------------------------------
for phrase in [
...
# ------------------------------------------------------------
# 7) Replace AI explanation module:
...
# ------------------------------------------------------------
# 8) Add heatmap aligned row helper
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# 9) Replace InsightMetricPill for one-line compact metrics
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# 10) Approved Bengali glossary correction
# ------------------------------------------------------------
replacements = {
...
print("OK: Signal Pro video final fix applied.")
